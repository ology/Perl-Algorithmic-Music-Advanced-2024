...
=head1 Application: Games

=begin pre

my @motifs = $mdp->motifs(16);
my @voices = map { [ map { $voice->rand } @$_ ] } @motifs;

$mdp->add_to_score($d->score, $motifs[7], $voices[7])
...
*Not* "interactive" - Remember that this talk is about rendering static MIDI files. So *you* have to figure out the "interactive" bit!
