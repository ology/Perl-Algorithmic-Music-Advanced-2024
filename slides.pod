...
Structured sequences created with a set of rules that determine rhythms, notes, or phrases
...
A constraint solver searches for solutions, where variables are bound without violating any constraints
...
Random sequences can be created by choosing notes from a pool of possibilities
...
Sequences can created by changing the chances of rhythms, notes, chords, or phrases of occuring
